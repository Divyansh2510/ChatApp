...
const ChatContainer = () => {
  ...
  const {messages,selectedUser,setSelectedUser,sendMsg,getMsg} = useContext(ChatContext)
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll py-3 pb-6'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <input  onChange={handleSendImage} type='file' id='image' accept='image/png , image/jpeg' hidden></input>
          <label htmlFor='image'>
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      <img src={assets.favicon2} alt='' className='w-100'/>
      <p className='text-lg font-medium text-white'>Chat Anytime, Chat Anywhere</p>
    </div>
  );
};
