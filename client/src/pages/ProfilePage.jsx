...
const handleSubmit = async (e) => {
    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
     ...
     <form  onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
      ...
      <label htmlFor='avatar' className='flex items-center gap-3 cursor-pointer'>
         <input type='file' onChange={(e)=>setSelectedImg(e.target.files[0])} id='avatar' accept='.png, .jpg, .jpeg' hidden></input>
         <img src={
  selectedImg
 ...
 alt=''
      ...
      required placeholder='Your Name'  className='p-2 border 
      border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' />
      <textarea onChange={(e)=>setBio(e.target.value)} value={bio}
      placeholder='Write Portfolio bio' required className='p-2 border border-gray-500 rounded-md focus:outline-none 
